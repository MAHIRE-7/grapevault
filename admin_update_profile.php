...
if(isset($_POST['update_profile'])){
   ...
   $update_pass = htmlspecialchars(strip_tags($_POST['update_pass']), ENT_QUOTES, 'UTF-8');

   $new_pass = md5($_POST['new_pass']);
   $new_pass = htmlspecialchars(strip_tags($_POST['new_pass']), ENT_QUOTES, 'UTF-8');

   $confirm_pass = md5($_POST['confirm_pass']);
   $confirm_pass = htmlspecialchars(strip_tags($_POST['confirm_pass']), ENT_QUOTES, 'UTF-8');
